...
public class URIBuilderUtilsTest {
    ...
    private final static String URL_WITH_ID = "https://api.resrobot.se/v2/trip?key=ff90d649-2b80-4bed-919d-cc672472a742&originId=740000001&destId=740000003&passlist=0&date=%s&time=07:30&format=json";
    private final static String URL_WITH_COORDINATES = "https://api.resrobot.se/v2/trip?key=ff90d649-2b80-4bed-919d-cc672472a742&originCoordLat=59.330136&originCoordLong=18.058151&destCoordLat=56.898778&destCoordLong=14.556322&passlist=0&date=%s&time=07:30&format=json";
    ...
    public void testBuildURLForIds() throws Exception {
        ...
        String expectedURL = String.format(URL_WITH_ID, DateUtils.calculateNextBusinessDate(LocalDate.now()));
        ...
        //Then
        assertEquals("URL not as expected.", expectedURL, url);
    }
    ...
    public void testBuildURLForCoordinates() throws Exception {
        ...
        String expectedURL = String.format(URL_WITH_COORDINATES, DateUtils.calculateNextBusinessDate(LocalDate.now()));
